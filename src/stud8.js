...
import './App.css';
import image1 from './uniform/adidas_x_19.3_fg_-_cblack-utiblk-silvmt_f35381__01.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'Adidas Nemeziz 19.2 Firm Ground Boots - Red adidas',
        price:"฿750",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  componentDidMount(){
    const itemsRef = firebase.database().ref('stud8');
