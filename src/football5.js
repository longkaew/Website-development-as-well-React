...
import './App.css';
import image1 from './uniform/apd_tigris_v_2_-_white_yellow_gk23ty23__01_new.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'APDD MATCH FA19 GOALKEEPER - BLACK/WHITE',
        price:"฿1,200",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/football5')
