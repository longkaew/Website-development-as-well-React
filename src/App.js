...
import image1 from './uniform/0f08c3c0-7089-45ad-abfd-760611afeb06_200x200.png';
...
if (user != null) {
  ...
  <div className="mr-5"><img className="rounded" src={image1} width="150" ></img></div>
    <div class="nav justify-content-center" >
      ...
      <a class="nav-item nav-link" ><Link to="/football"><font color="white">สินค้า</font></Link></a>
      <a class="nav-item nav-link" ><Link to="/login"><font color="white">Admin</font></Link></a>
    </div>
  </div>
</nav>
</header>      
