...
import image1 from './uniform/ptt-cb-bluewave-7851-60274-1.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'ชุดแข่งทีมชลบุรี เอฟซี 2018',
        price:"฿600",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/unifrom1')
...
componentDidMount(){
  const itemsRef = firebase.database().ref('unifrom5');
