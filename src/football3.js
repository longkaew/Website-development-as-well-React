...
import './App.css';
import image1 from './uniform/adidas_finale_ttrn_-_white-brcyan-syello_dy2551__01jaaa_new.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'ADIDAS FINALE OMB - 5 - WHITE/BRCYAN/SYELLO',
        price:"฿4,200",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/football3')
