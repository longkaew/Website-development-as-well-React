...
import './App.css';
import image1 from './uniform/morelia_neo_ii_mij_-_black-white-red_p1ga165001__01_new.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'MIZUNO MORELIA NEO Firm Ground Boots Dark Grey',
        price:"฿1,999",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  componentDidMount(){
    const itemsRef = firebase.database().ref('stud4');
