...
import './App.css';
import image1 from './uniform/apd_flash_-_orange_gk29wco__02.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'APD FLASH - ORANGE PREDATOR PRO WHITE/BLACK',
        price:"฿1,000",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/football6')
