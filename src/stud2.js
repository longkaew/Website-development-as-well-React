...
import './App.css';
import image1 from './uniform/mizuno_rebula_3_japan_p1ga196001275__01_new.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'mizono รองเท้าฟุตบอล รองเท้าสตั๊ด ADIDAS Predator 18.3 FG',
        price:"฿1,000",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  componentDidMount(){
    const itemsRef = firebase.database().ref('stud2');
