...
import './App.css';
import image1 from './uniform/adidas_nemeziz_19.2_fg_-_shopnk-cblack-shopnk_f34384__01.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'ADIDAS NEMEZIZ 19.2 FG - SHOPNK/CBLACK/SHOPNK',
        price:"฿899",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  componentDidMount(){
    const itemsRef = firebase.database().ref('stud5');
