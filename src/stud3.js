...
import './App.css';
import image1 from './uniform/mizuno_morelia_neo_ii_-_red-black_p1ga195062__00.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'MIZUNO Football Shoe Goletto 6 Firm Ground AQ4282',
        price:"฿1,399",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  componentDidMount(){
    const itemsRef = firebase.database().ref('stud3');
