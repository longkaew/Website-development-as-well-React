...
import './App.css';
import image1 from './uniform/adidas_f50_fg_-_none_none_none_ee8428__02.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'ADIDAS MERCURIAL SUPERFLY  ELITE MDS FG - BLUE VOID',
        price:"฿1,200",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/stud1')
