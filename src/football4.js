...
import './App.css';
import image1 from './uniform/nike_pl_nk_strk-fa19_-_white-black-black-racer_pink_sc3552-100__01.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'NIKE PREMIER LEAGUE STRIKE WHITE/BLACK/BLACK',
        price:"฿599",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/football4')
