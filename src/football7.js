...
import './App.css';
import image1 from './uniform/adidas_pred_trn_-_brcyan_black_dy2615__02.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'ADIDAS PREDATOR TRAINING - BRCYAN/BLACK BULE',
        price:"฿700",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  updateItem3 = () =>{
    ...
    const itemsRef = firebase.database().ref('/football7')
