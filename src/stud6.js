...
import './App.css';
import image1 from './uniform/adidas_x_19.3_fg_-_brcyan-cblack-shopnk_f35383__01.jpg';
    ...
    constructor(props){
      super(props)
       this.state={
        ...
        item_id:'',
        title:"",
        name:'ADIDAS X Campo Topper Ground Boots Dark Grey',
        price:"฿999",
        size:'',
        Number:"",
        plus:0,
...
handleSubmit(e){  
  ...
  componentDidMount(){
    const itemsRef = firebase.database().ref('stud6');
